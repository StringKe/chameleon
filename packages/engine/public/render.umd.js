(function (x, st) {
  typeof exports == 'object' && typeof module < 'u'
    ...
    : ((x = typeof globalThis < 'u' ? globalThis : x || self), (x.CRender = st(x.React, x.ReactDOM)));
})(this, function (x, st) {
  'use strict';
  function oi(e) {
  ...
  function ii() {
    ...
    function i(s, u, f) {
      var l,
        ...
        d = null,
        v = null;
      f !== void 0 && (d = '' + f), u.key !== void 0 && (d = '' + u.key), u.ref !== void 0 && (v = u.ref);
      for (l in u) n.call(u, l) && !a.hasOwnProperty(l) && (p[l] = u[l]);
      if (s && s.defaultProps) for (l in ((u = s.defaultProps), u)) p[l] === void 0 && (p[l] = u[l]);
      ...
      gn ||
        ...
        '{}'.NODE_ENV !== 'production' &&
          (function () {
            ...
            function U(c, h, m) {
              {
                var S = j.ReactDebugCurrentFrame,
                  M = S.getStackAddendum();
                M !== '' && ((h += '%s'), (m = m.concat([M])));
                var T = m.map(function (R) {
                  return String(R);
                });
                T.unshift('Warning: ' + h), Function.prototype.apply.call(console[c], console, T);
              }
            }
            var I = !1,
              Y = !1,
            ...
            function Nt() {
              {
                ...
                _e < 0 && O('disabledDepth fell below zero. This is a bug in React. Please file an issue.');
              }
            }
            var Rt = j.ReactCurrentDispatcher,
              ln;
            function Qt(c, h, m) {
              {
                if (ln === void 0)
...
` + N[z].replace(' at new ', ' at ');
                            return (
                              c.displayName &&
                                ...
                                (oe = oe.replace('<anonymous>', c.displayName)),
                              typeof c == 'function' && Xt.set(c, oe),
                              oe
                            );
                          }
                        while (z >= 1 && W >= 0);
            ...
            function Kt(c, h, m) {
              if (c == null) return '';
              if (typeof c == 'function') return Ga(c, Fm(c));
            ...
            function er(c) {
              if (c) {
                var h = c._owner,
                  m = Kt(c.type, c._source, h ? h.type : null);
                Ha.setExtraStackFrame(m);
              } else Ha.setExtraStackFrame(null);
            }
                ...
                for (var R in c)
                  if (T(c, R)) {
                    ...
                    try {
                      ...
                      N = c[R](h, R, S, m, null, 'SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED');
                    } catch (z) {
                      N = z;
                    }
                    N &&
                      ...
                      N instanceof Error &&
                        !(N.message in Wa) &&
                        ((Wa[N.message] = !0), er(M), O('Failed %s type: %s', m, N.message), er(null));
                  }
              }
            }
            ...
            function Um(c) {
              {
                var h = typeof Symbol == 'function' && Symbol.toStringTag,
                  m = (h && c[Symbol.toStringTag]) || c.constructor.name || 'Object';
                return m;
              }
            }
            function Vm(c) {
            ...
            function Hm(c, h) {
              if (typeof c.ref == 'string' && Mt.current && h && Mt.current.stateNode !== h) {
            ...
            function Ym(c, h) {
              {
                ...
                (m.isReactWarning = !0), Object.defineProperty(c, 'key', { get: m, configurable: !0 });
              }
            }
            function Jm(c, h) {
              {
                ...
                (m.isReactWarning = !0), Object.defineProperty(c, 'ref', { get: m, configurable: !0 });
              }
            }
            ...
            function Qm(c, h, m, S, M) {
              {
                ...
                m !== void 0 && (Ja(m), (N = '' + m)),
                  ...
                  Gm(h) && ((Q = h.ref), Hm(h, M));
                for (T in h) Zt.call(h, T) && !zm.hasOwnProperty(T) && (R[T] = h[T]);
                if (c && c.defaultProps) {
                  var z = c.defaultProps;
                  for (T in z) R[T] === void 0 && (R[T] = z[T]);
                }
                if (N || Q) {
            ...
            var hn = j.ReactCurrentOwner,
              Xa = j.ReactDebugCurrentFrame;
            function at(c) {
              if (c) {
                var h = c._owner,
                  m = Kt(c.type, c._source, h ? h.type : null);
                Xa.setExtraStackFrame(m);
              } else Xa.setExtraStackFrame(null);
            }
            var vn;
            vn = !1;
            function mn(c) {
...
Check the top-level render call using <` +
            ...
            function ti(c, h) {
              {
                ...
                else if (mn(c)) c._store && (c._store.validated = !0);
                else if (c) {
                  var M = w(c);
                  if (typeof M == 'function' && M !== c.entries)
                    for (var T = M.call(c), R; !(R = T.next()).done; ) mn(R.value) && ei(R.value, h);
                }
              }
            }
            function Zm(c) {
              {
                ...
                var m;
                if (typeof h == 'function') m = h.propTypes;
                else if (typeof h == 'object' && (h.$$typeof === u || h.$$typeof === p)) m = h.propTypes;
                else return;
                if (m) {
                  var S = ue(h);
            ...
            function ey(c) {
              {
                ...
                c.ref !== null && (at(c), O('Invalid attribute `ref` supplied to `React.Fragment`.'), at(null));
              }
            }
            function ri(c, h, m, S, M, T) {
              {
                ...
                if (R) {
                  ...
                  if (oe !== void 0)
                    if (S)
                      if (dn(oe)) {
                        for (var it = 0; it < oe.length; it++) ti(oe[it], c);
  ...
  var ci = Object.defineProperty,
    ui = (e, t, r) => (t in e ? ci(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r)),
  ...
  const li = (e) => () => {
    ...
    En = (e) =>
      [...jn, ...fi].reduce((t, r) => {
        var n;
        return e != null && e[r] ? (t[r] = (n = e[r]) == null ? void 0 : n.bind(e)) : jn.includes(r) && (t[r] = li), t;
      }, {});
  var di = Object.defineProperty,
    pi = (e, t, r) => (t in e ? di(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r)),
  ...
  function Ce(e) {
    return e == null ? (e === void 0 ? Oi : Si) : On && On in Object(e) ? _i(e) : wi(e);
  }
  function fe(e) {
  ...
  function rr(e) {
    return typeof e == 'symbol' || (fe(e) && Ce(e) == Ci);
  }
  function nr(e, t) {
  ...
  const V = xi;
  var Ni = 1 / 0,
    Cn = re ? re.prototype : void 0,
    xn = Cn ? Cn.toString : void 0;
  function Nn(e) {
    if (typeof e == 'string') return e;
    if (V(e)) return nr(e, Nn) + '';
    if (rr(e)) return xn ? xn.call(e) : '';
    var t = e + '';
  ...
  var ns = $t
      ? function (e, t) {
          return $t(e, 'toString', { configurable: !0, enumerable: !1, value: ts(t), writable: !0 });
        }
      : or,
    os = es(ns);
  const An = os;
  ...
  function cr(e, t, r) {
    t == '__proto__' && $t ? $t(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 }) : (e[t] = r);
  }
  function ft(e, t) {
    return e === t || (e !== e && t !== t);
  }
  ...
  function Pn(e, t, r) {
    return (
      (t = Tn(t === void 0 ? e.length - 1 : t, 0)),
      function () {
        for (var n = arguments, o = -1, a = Tn(n.length - t, 0), i = Array(a); ++o < a; ) i[o] = n[t + o];
        o = -1;
  ...
  function Tt(e) {
    return e != null && lr(e.length) && !ar(e);
  }
  function ms(e, t, r) {
    if (!ae(r)) return !1;
    var n = typeof t;
    return (n == 'number' ? Tt(r) && At(t, r.length) : n == 'string' && t in r) ? ft(r[t], e) : !1;
  }
  function ys(e) {
  ...
  function fr(e) {
    var t = e && e.constructor,
      r = (typeof t == 'function' && t.prototype) || gs;
    return e === r;
  }
  function bs(e, t) {
  ...
  var Fn = typeof exports == 'object' && exports && !exports.nodeType && exports,
    Ln = Fn && typeof module == 'object' && module && !module.nodeType && module,
    Os = Ln && Ln.exports === Fn,
    Bn = Os ? le.Buffer : void 0,
    Cs = Bn ? Bn.isBuffer : void 0,
    xs = Cs || Ss;
  const pt = xs;
  ...
  (D[zs] = D[Gs] = D[Ws] = D[Hs] = D[Ys] = D[Js] = D[qs] = D[Qs] = D[Xs] = !0),
    (D[Ns] =
      ...
      D[Bs] =
        !1);
  function Ks(e) {
    return fe(e) && lr(e.length) && !!D[Ce(e)];
  }
  function dr(e) {
    return function (t) {
      return e(t);
  ...
  var Un = typeof exports == 'object' && exports && !exports.nodeType && exports,
    ht = Un && typeof module == 'object' && module && !module.nodeType && module,
    Zs = ht && ht.exports === Un,
    pr = Zs && wn.process,
    ec = (function () {
      try {
  ...
  function cc(e) {
    if (!fr(e)) return ac(e);
    var t = [];
    for (var r in Object(e)) sc.call(e, r) && r != 'constructor' && t.push(r);
    return t;
  }
  function Pt(e) {
    return Tt(e) ? zn(e) : cc(e);
  }
  function uc(e) {
    var t = [];
  ...
  var lc = Object.prototype,
    fc = lc.hasOwnProperty;
  function dc(e) {
    if (!ae(e)) return uc(e);
    var t = fr(e),
      r = [];
    for (var n in e) (n == 'constructor' && (t || !fc.call(e, n))) || r.push(n);
    return r;
  }
  function vt(e) {
    return Tt(e) ? zn(e, !0) : dc(e);
  }
  var pc = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
    hc = /^\w*$/;
  function vr(e, t) {
  ...
  function Cc(e, t) {
    var r = this.__data__;
    return (this.size += this.has(e) ? 0 : 1), (r[e] = mt && t === void 0 ? Oc : t), this;
  }
  function Re(e) {
    var t = -1,
      r = e == null ? 0 : e.length;
  ...
  (Re.prototype.clear = mc),
    (Re.prototype.delete = yc),
    (Re.prototype.get = jc),
    (Re.prototype.has = Sc),
    (Re.prototype.set = Cc);
  function xc() {
  ...
  (me.prototype.clear = Dc),
    (me.prototype.delete = Ic),
    (me.prototype.get = Fc),
    (me.prototype.has = Lc),
    (me.prototype.set = Bc);
  var Uc = 'Expected a function';
  function mr(e, t) {
    if (typeof e != 'function' || (t != null && typeof t != 'function')) throw new TypeError(Uc);
    var r = function () {
      var n = arguments,
  ...
  function Ve(e, t) {
    return V(e) ? e : vr(e, t) ? [e] : Yc(Jc(e));
  }
  var qc = 1 / 0;
  function ze(e) {
    if (typeof e == 'string' || rr(e)) return e;
    var t = e + '';
    return t == '0' && 1 / e == -qc ? '-0' : t;
  }
  function It(e, t) {
    t = Ve(t, e);
    for (var r = 0, n = t.length; e != null && r < n; ) e = e[ze(t[r++])];
  ...
  function gr(e, t, r, n, o) {
    ...
    for (r || (r = Qc), o || (o = []); ++a < i; ) {
      var s = e[a];
      t > 0 && r(s) ? (t > 1 ? gr(s, t - 1, r, n, o) : yr(o, s)) : n || (o[o.length] = s);
    }
    return o;
  }
  function Xc(e) {
  ...
  function fu(e, t) {
    ...
    if (r instanceof ve) {
      var n = r.__data__;
      if (!yt || n.length < lu - 1) return n.push([e, t]), (this.size = ++r.size), this;
  ...
  (ie.prototype.clear = iu),
    (ie.prototype.delete = su),
    (ie.prototype.get = cu),
    (ie.prototype.has = uu),
    (ie.prototype.set = fu);
  function du(e, t) {
    return e && Be(t, Pt(t), e);
  }
  function pu(e, t) {
    return e && Be(t, vt(t), e);
  }
  var Jn = typeof exports == 'object' && exports && !exports.nodeType && exports,
    qn = Jn && typeof module == 'object' && module && !module.nodeType && module,
    hu = qn && qn.exports === Jn,
    Qn = hu ? le.Buffer : void 0,
    Xn = Qn ? Qn.allocUnsafe : void 0;
  function Kn(e, t) {
    if (t) return e.slice();
    var r = e.length,
      n = Xn ? Xn(r) : new e.constructor(r);
    return e.copy(n), n;
  }
  function vu(e, t) {
  ...
  var no = '[object Map]',
    ...
    $u = xe(sr),
    Me = Ce;
  ((wr && Me(new wr(new ArrayBuffer(1))) != so) ||
    (yt && Me(new yt()) != no) ||
    (Sr && Me(Sr.resolve()) != oo) ||
    (Ge && Me(new Ge()) != ao) ||
    (sr && Me(new sr()) != io)) &&
  ...
  var co = re ? re.prototype : void 0,
    uo = co ? co.valueOf : void 0;
  function Lu(e) {
  ...
  function bt(e, t, r, n, o, a) {
    ...
    var l = V(e);
    if (l) {
      if (((i = Pu(e)), !s)) return $n(e, i);
    } else {
      var p = gt(e),
        d = p == mo || p == jl;
      if (pt(e)) return Kn(e, s);
      if (p == yo || p == vo || (d && !o)) {
        if (((i = u || d ? {} : fo(e)), !s)) return u ? Eu(e, pu(i, e)) : bu(e, du(i, e));
      } else {
        if (!P[p]) return o ? e : {};
        i = al(e, p, s);
      }
    ...
    a.set(e, i),
      pl(e)
        ? e.forEach(function (w) {
            i.add(bt(w, t, r, w, e, a));
          })
        : ul(e) &&
          e.forEach(function (w, j) {
            i.set(j, bt(w, t, r, j, e, a));
          });
    var g = f ? (u ? Er : jr) : u ? vt : Pt,
      E = l ? void 0 : g(e);
    return (
      as(E || e, function (w, j) {
        E && ((j = w), (w = e[j])), ur(i, j, bt(w, t, r, j, e, a));
      }),
      i
    );
  }
  ...
  function _o(e, t, r, n, o, a) {
    ...
    var p = -1,
      d = !0,
      v = r & Yl ? new _t() : void 0;
    for (a.set(e, t), a.set(t, e); ++p < s; ) {
      var g = e[p],
        E = t[p];
      if (n) var w = i ? n(E, g, p, t, e, a) : n(g, E, p, e, t, a);
      if (w !== void 0) {
        if (w) continue;
        d = !1;
        break;
      ...
      if (v) {
        if (
          !Wl(t, function (j, O) {
            if (!bo(v, O) && (g === j || o(g, j, r, n, a))) return v.push(O);
          })
        ) {
          d = !1;
          break;
  ...
  function pf(e, t, r, n, o, a) {
    ...
    for (var p = u; p--; ) {
      var d = s[p];
      if (!(i ? d in t : df.call(t, d))) return !1;
    }
    var v = a.get(e),
      g = a.get(t);
    ...
    for (var w = i; ++p < u; ) {
      ...
      var j = e[d],
        O = t[d];
      if (n) var U = i ? n(O, j, d, t, e, a) : n(j, O, d, e, t, a);
  ...
  function mf(e, t, r, n, o, a) {
    ...
    if (d && !l) return a || (a = new ie()), i || hr(e) ? _o(e, t, r, n, o, a) : uf(e, t, u, r, n, o, a);
    if (!(r & hf)) {
      var v = l && So.call(e, '__wrapped__'),
        g = p && So.call(t, '__wrapped__');
      if (v || g) {
        var E = v ? e.value() : e,
          w = g ? t.value() : t;
  ...
  function Nr(e, t, r, n, o) {
    return e === t ? !0 : e == null || t == null || (!fe(e) && !fe(t)) ? e !== e && t !== t : mf(e, t, r, n, Nr, o);
  }
  var yf = 1,
    gf = 2;
  function bf(e, t, r, n) {
    ...
    for (; ++o < a; ) {
      ...
      if (i && s[2]) {
        ...
        var p = new ie();
        if (n) var d = n(f, l, u, e, t, p);
        if (!(d === void 0 ? Nr(l, f, yf | gf, n, p) : d)) return !1;
      }
    }
    return !0;
  }
  ...
  function wf(e, t, r) {
    ...
    return a || ++n != o ? a : ((o = e == null ? 0 : e.length), !!o && lr(o) && At(i, o) && (V(e) || dt(e)));
  }
  function Sf(e, t) {
    return e != null && wf(e, t, Ef);
  }
  var Of = 1,
    Cf = 2;
  function xf(e, t) {
  ...
  function Mf(e) {
    return vr(e) ? Nf(ze(e)) : Rf(e);
  }
  function Rr(e) {
    return typeof e == 'function' ? e : e == null ? or : typeof e == 'object' ? (V(e) ? xf(e[0], e[1]) : jf(e)) : Mf(e);
  }
  function $f(e) {
  ...
  function xo(e, t, r, n, o) {
    e !== t &&
      Tf(
        t,
        function (a, i) {
          if ((o || (o = new ie()), ae(a))) Df(e, t, i, r, xo, n, o);
          else {
  ...
  function If(e, t) {
    return t.length < 2 ? e : It(e, au(t, 0, -1));
  }
  var Ff = ys(function (e, t, r) {
    xo(e, t, r);
  });
  const Ro = Ff;
  ...
  var zf = 1,
    ...
    Hf = Kc(function (e, t) {
      ...
      var n = !1;
      (t = nr(t, function (a) {
        return (a = Ve(a, e)), n || (n = a.length > 1), a;
      })),
        Be(e, Er(e), r),
        n && (r = bt(r, zf | Gf | Wf, Vf));
      for (var o = t.length; o--; ) Uf(r, t[o]);
      return r;
    });
  const Mo = Hf;
  function Yf(e, t, r, n) {
    ...
    for (var o = -1, a = t.length, i = a - 1, s = e; s != null && ++o < a; ) {
      ...
      if (o != i) {
        var l = s[u];
        (f = n ? n(l, u, s) : void 0), f === void 0 && (f = ae(l) ? l : At(t[o + 1]) ? [] : {});
      }
      ur(s, u, f), (s = s[u]);
    }
    return e;
  ...
  function td(e, t, r) {
    ...
    e: for (; ++n < a; ) {
      ...
      if (((l = r || l !== 0 ? l : 0), i && p === p)) {
        ...
        t && u.push(p), s.push(l);
      } else o(u, p, r) || (u !== s && u.push(p), s.push(l));
    }
    return s;
  }
  ...
  function od(e) {
    return se(e) && typeof e[Symbol.iterator] == 'function';
  }
  function se(e) {
  ...
  function id(e, t, r, n) {
    ...
    const { path: o, branch: a } = t,
      ...
      {
        refinement: s,
        message: u = `Expected a value of type \`${i}\`${s ? ` with refinement \`${s}\`` : ''}, but received: \`${Z(
          n
        )}\``,
      } = e;
    return {
  ...
  function* Tr(e, t, r) {
    ...
    const { path: n = [], branch: o = [e], coerce: a = !1, mask: i = !1 } = r,
      s = { path: n, branch: o };
    if (a && ((e = t.coercer(e, s)), i && t.type !== 'type' && se(t.schema) && se(e) && !Array.isArray(e)))
      for (const f in e) t.schema[f] === void 0 && delete e[f];
    let u = 'valid';
    for (const f of t.validator(e, s)) (u = 'not_valid'), yield [f, void 0];
    ...
    if (u !== 'not_valid') for (const f of t.refiner(e, s)) (u = 'not_refined'), yield [f, void 0];
  ...
  function B(e) {
    return new de({
      ...
      *entries(t) {
      ...
      validator(t) {
        return Array.isArray(t) || `Expected an array value, but received: ${Z(t)}`;
      },
    });
  }
  function $e() {
    return Ee('boolean', (e) => typeof e == 'boolean');
  }
  function Dr(e) {
    const t = {},
      r = e.map((n) => Z(n)).join();
  ...
  function Do() {
    return Ee('func', (e) => typeof e == 'function' || `Expected a function, but received: ${Z(e)}`);
  }
  function K(e) {
    const t = Z(e),
      r = typeof e;
  ...
  function ko() {
    return Ee('number', (e) => (typeof e == 'number' && !isNaN(e)) || `Expected a number, but received: ${Z(e)}`);
  }
  function $(e) {
    ...
    return new de({
      ...
      *entries(n) {
      ...
      validator(n) {
        return se(n) || `Expected an object, but received: ${Z(n)}`;
      },
      coercer(n) {
        return se(n) ? { ...n } : n;
      },
  ...
  function jt(e, t) {
    return new de({
      ...
      *entries(r) {
      ...
      validator(r) {
        return se(r) || `Expected an object, but received: ${Z(r)}`;
      },
    });
  }
  function y() {
    return Ee('string', (e) => typeof e == 'string' || `Expected a string, but received: ${Z(e)}`);
  }
  function Io(e) {
    ...
    return new de({
      ...
      schema: e,
      *entries(r) {
        if (se(r)) for (const n of t) yield [n, r[n], e[n]];
      },
      validator(r) {
        return se(r) || `Expected an object, but received: ${Z(r)}`;
      },
  ...
  function J(e) {
    ...
    return new de({
      ...
      validator(r, n) {
        ...
        return [`Expected the value to satisfy a union of \`${t}\`, but received: ${Z(r)}`, ...o];
      },
    });
  }
  function fd() {
  ...
  const kr = $({
    ...
    dd = B(kr),
    pd = ['CBlock', 'CContainer', 'CImage', 'CCanvas', 'CVideo', 'CAudio', 'CText', 'CNativeTag'];
  var ne = ((e) => ((e.SLOT = 'SLOT'), (e.FUNCTION = 'FUNCTION'), (e.EXPRESSION = 'EXPRESSION'), e))(ne || {}),
    Ir = ((e) => ((e.DESIGN = 'design'), (e.SAVE = 'save'), e))(Ir || {}),
    Fr = ((e) => ((e.FUNC = 'FUNC'), (e.COMP = 'COMP'), e))(Fr || {});
  const hd = () =>
      Ee('normalObj', (e) =>
        !X(e) || [ne.SLOT, ne.EXPRESSION, ne.FUNCTION].includes(e == null ? void 0 : e.type)
          ? !1
          : (We(e, jt(y(), Lr)), !0)
      ),
    Lr = J([
  ...
  const yd = $({ type: K('array'), value: He(() => B(Ut)) }),
    Ut = J([
      ...
      Dr(['component', 'expression', 'function']),
      vd,
      md,
      yd,
    ]),
  ...
  const bd = $({
    ...
    _d = $({
      ...
      props: B(
        J([
          Br,
          $({ title: b(Bt), type: K('single'), content: Br }),
          $({ title: b(Bt), type: K('group'), content: B(Br) }),
        ])
      ),
      fixedProps: b(G()),
      isContainer: b(J([$e(), $({ placeholder: y(), width: y(), height: y() })])),
...
`
  ...
  const Ed = $({ type: K(ne.FUNCTION), value: y() }),
    wd = Pr(Po(Ye, ['componentName']), $({ componentName: K('RootContainer') }));
  function Sd(e) {
    return {
      all: (e = e || new Map()),
      on: function (t, r) {
      ...
      return (
        ...
        n &&
          (V(n)
            ...
            : X(n) && r.value.push(new F(n, { parent: t, materials: o }))),
        r
      );
    };
  class qe {
    constructor(t, r) {
      C(this, 'nodeType', 'SLOT'),
        C(this, 'rawData'),
        C(this, 'parent'),
        C(this, 'emitter', Et),
        C(this, 'data'),
  ...
  const Lo = (e) => {
      ...
      return (
        e.forEach((r) => {
          ...
          n.type
            ? n.type === Ur.SINGLE
              ? t.push(n.content)
              : n.type === Ur.GROUP && (t = [...t, ...Lo(n.content)])
            : t.push(r);
        }),
        t
      );
    ...
    zr = (e, t, r) => {
      if (e.type) return e.type === ne.SLOT ? new qe(e, { parent: t, materials: r }) : e;
      if (X(e)) {
        const n = {};
        return (
      ...
      } else return Array.isArray(e) ? e.map((n) => zr(n, t, r)) : e;
    },
    Gr = (e, t, r) => (X(e) ? zr(e, t, r) : V(e) ? e.map((n) => zr(n, t, r)) : e);
  class we {
    constructor(t, r, n) {
      C(this, 'nodeType', 'PROP'),
        C(this, 'rawData'),
        C(this, 'parent'),
        C(this, 'emitter', Et),
        C(this, 'data'),
    ...
    get material() {
      ...
      if (t instanceof F) {
        const r = t.material;
        return Lo((r == null ? void 0 : r.value.props) || []).find((n) => n.name === this.name);
      } else return null;
    }
    export(t) {
      const r = this.data,
        n = (o) => {
          if (o instanceof we || o instanceof qe || o instanceof F) return o.export(t);
          if (V(o)) return o.map((a) => n(a));
          if (X(o)) {
            const a = {};
            return (
              Object.keys(o || {}).forEach((i) => {
  ...
  class F {
    constructor(t, r) {
      C(this, 'nodeType', 'NODE'),
        C(this, 'rawData'),
        C(this, 'data'),
        C(this, 'emitter', Et),
        C(this, 'parent'),
        C(this, 'materialsModel'),
        C(this, 'listenerHandle'),
        C(this, 'onChangeCbQueue'),
    ...
    updateValue(t) {
      const r = this.data,
        n = { ...this.data, ...t };
      (this.data = Bo(n, this)), this.emitter.emit('onNodeChange', { value: n, preValue: r, node: this });
    }
    contains(t) {
      return Yr(this, t);
    }
    ...
    export(t) {
      ...
      Object.keys(n.props || {}).forEach((l) => {
        o[l] = n.props[l].export(t);
      });
      const a = (r = n.children) == null ? void 0 : r.map((l) => (l instanceof F ? l.export(t) : l)),
        i = n.configure || {},
        s = i.propsSetter || {},
        u = {};
  ...
  const Uo = (e, t, r) => {
    ...
    let o = [];
    V(e.children)
      ? (o = e.children.map((i) => (i instanceof F ? i : X(i) ? new F(i, { parent: t, materials: r }) : i)))
      : e.children instanceof F
      ? o.push(e.children)
      : e.children && X(e.children) && o.push(new F(e.children, { parent: t, materials: r }));
    ...
    return (
      a.length &&
        a.forEach((i) => {
          ...
          u instanceof we ? (n.props[i] = u) : (n.props[i] = new we(i, u || '', { parent: t, materials: r }));
        }),
      (n.children = o),
      n
    );
  ...
  class wt {
    constructor(t, { parent: r, materials: n }) {
      C(this, 'rawData'),
        C(this, 'data'),
        C(this, 'nodeType', Je.ROOT_CONTAINER),
        C(this, 'emitter', Et),
        C(this, 'materialsModel'),
        C(this, 'listenerHandle'),
        C(this, 'onChangeCbQueue'),
    ...
    export(t = Ir.SAVE) {
      ...
      const a =
          ((r = n.children) == null
            ...
            : r.map((u) => {
                var f;
                return (f = u == null ? void 0 : u.export) == null ? void 0 : f.call(u, t);
              })) || [],
  ...
  const Ae = (e) => (e == null ? void 0 : e.type) === ne.EXPRESSION,
    ...
    Hr = (e) => Qf(e, (t) => (X(t) ? !Object.keys(t).length : V(t) ? !t.length : !t));
  function Md(e, t) {
    const r = [e];
    for (; r.length; ) {
      const n = r.shift();
  ...
  const Td = (e) => {
      if (!V(e)) throw new Error('Materials must be a array');
      return e.map((t) => new Ad(t));
    },
    Pd = (e) => {
      e == null ||
        e.forEach((t) => {
          Vr({ data: t, dataStruct: _d, throwError: !1 });
        });
    };
  class Te {
    constructor(t) {
      C(this, 'rawData'), C(this, 'data'), C(this, 'usedMaterials', []), (this.rawData = t), Pd(t), (this.data = Td(t));
    }
      ...
      return (
        r.forEach((a) => {
          ...
          if (u.length !== 0) {
            ...
            const f = [];
            i.forEach((p) => {
              s[p].length && f.push({ name: p, list: s[p] });
            });
  ...
  class Vt {
    constructor(t, r) {
      C(this, 'nodeType', 'PAGE'),
        C(this, 'rawData'),
        C(this, 'emitter', Et),
        C(this, 'data'),
        C(this, 'parent'),
        C(this, 'materialsModel'),
        C(this, 'assetPackagesList'),
        Vo(t),
        (this.rawData = JSON.parse(JSON.stringify(t))),
        (this.materialsModel = new Te((r == null ? void 0 : r.materials) || [])),
        (this.data = Jr(t, this, this.materialsModel)),
        (this.assetPackagesList = [...((r == null ? void 0 : r.assetPackagesList) || []), ...(this.data.assets || [])]);
    }
    updatePage(t) {
      const r = this.data;
      (this.rawData = JSON.parse(JSON.stringify(t))),
    ...
    addNode(t, r, n = 'AFTER') {
      ...
      if (n === 'AFTER' || n === 'BEFORE') {
        const a = r.parent;
        if (a === null && r instanceof wt) return console.warn('Not found parent node'), !1;
        if (a instanceof we) return console.warn('CProp can not add node'), !1;
        if (a instanceof qe) {
          const s = a.value.value,
            u = s.findIndex((f) => f === r) ?? -1;
          return u >= 0
      ...
      const n = this.data.componentsTree.export(t),
        ...
        i = this.materialsModel.usedMaterials
          .map((u) => {
            const f = o.find((l) => {
              var p;
              return l.package === ((p = u.value.npm) == null ? void 0 : p.package);
            });
            return (
              f && a.push(f),
              {
  ...
  function Ot(e) {
    return e == null ? (e === void 0 ? Yd : Hd) : Wo && Wo in Object(e) ? Vd(e) : Wd(e);
  }
  function Ke(e) {
    return e != null && typeof e == 'object';
  }
  ...
  function qd(e) {
    return typeof e == 'symbol' || (Ke(e) && Ot(e) == Jd);
  }
  function Qd(e, t) {
    for (var r = -1, n = e == null ? 0 : e.length, o = Array(n); ++r < n; ) o[r] = t(e[r], r, e);
    return o;
  ...
  const Ze = Xd;
  var Kd = 1 / 0,
    Ho = Xe ? Xe.prototype : void 0,
    Yo = Ho ? Ho.toString : void 0;
  function Jo(e) {
    if (typeof e == 'string') return e;
    if (Ze(e)) return Qd(e, Jo) + '';
    if (qd(e)) return Yo ? Yo.call(e) : '';
    var t = e + '';
  ...
  var Zd = '[object AsyncFunction]',
    ep = '[object Function]',
    tp = '[object GeneratorFunction]',
    rp = '[object Proxy]';
  function qr(e) {
    if (!Pe(e)) return !1;
    var t = Ot(e);
  ...
  var xp = zt
      ? function (e, t) {
          return zt(e, 'toString', { configurable: !0, enumerable: !1, value: Op(t), writable: !0 });
        }
      : qo,
    Np = Sp(xp);
  const Rp = Np;
  ...
  function Ko(e, t) {
    var r = typeof e;
    return (t = t ?? Mp), !!t && (r == 'number' || (r != 'symbol' && $p.test(e))) && e > -1 && e % 1 == 0 && e < t;
  }
  function Kr(e, t, r) {
    t == '__proto__' && zt ? zt(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 }) : (e[t] = r);
  }
  function Gt(e, t) {
    return e === t || (e !== e && t !== t);
  }
  var Ap = Object.prototype,
    Tp = Ap.hasOwnProperty;
  function Pp(e, t, r) {
    var n = e[t];
  ...
  function kp(e, t, r) {
    return (
      (t = Zo(t === void 0 ? e.length - 1 : t, 0)),
      function () {
        for (var n = arguments, o = -1, a = Zo(n.length - t, 0), i = Array(a); ++o < a; ) i[o] = n[t + o];
        o = -1;
        for (var s = Array(t + 1); ++o < t; ) s[o] = n[o];
  ...
  function Zr(e) {
    return e != null && ea(e.length) && !qr(e);
  }
  function Lp(e, t, r) {
    if (!Pe(r)) return !1;
    var n = typeof t;
    return (n == 'number' ? Zr(r) && Ko(t, r.length) : n == 'string' && t in r) ? Gt(r[t], e) : !1;
  }
  function Bp(e) {
  ...
  function ta(e) {
    var t = e && e.constructor,
      r = (typeof t == 'function' && t.prototype) || Up;
    return e === r;
  }
  function Vp(e, t) {
    for (var r = -1, n = Array(e); ++r < e; ) n[r] = t(r);
  ...
  var na = Object.prototype,
    Gp = na.hasOwnProperty,
    Wp = na.propertyIsEnumerable,
    Hp = ra(
      (function () {
        return arguments;
      })()
  ...
  var oa = typeof exports == 'object' && exports && !exports.nodeType && exports,
    aa = oa && typeof module == 'object' && module && !module.nodeType && module,
    Jp = aa && aa.exports === oa,
    ia = Jp ? Qe.Buffer : void 0,
    qp = ia ? ia.isBuffer : void 0,
    Qp = qp || Yp;
  const sa = Qp;
  ...
  (k[dh] = k[ph] = k[hh] = k[vh] = k[mh] = k[yh] = k[gh] = k[bh] = k[_h] = !0),
    (k[Xp] =
      ...
      k[uh] =
        !1);
  function jh(e) {
    return Ke(e) && ea(e.length) && !!k[Ot(e)];
  }
  function Eh(e) {
    return function (t) {
      return e(t);
  ...
  var ca = typeof exports == 'object' && exports && !exports.nodeType && exports,
    Ct = ca && typeof module == 'object' && module && !module.nodeType && module,
    wh = Ct && Ct.exports === ca,
    tn = wh && zo.process,
    Sh = (function () {
      try {
  ...
  const ua = Sh;
  var la = ua && ua.isTypedArray,
    Oh = la ? Eh(la) : jh;
  const fa = Oh;
  var Ch = Object.prototype,
    xh = Ch.hasOwnProperty;
  function Nh(e, t) {
    var r = Ze(e),
      n = !r && en(e),
      o = !r && !n && sa(e),
  ...
  function Th(e) {
    ...
    var t = ta(e),
      r = [];
    for (var n in e) (n == 'constructor' && (t || !Ah.call(e, n))) || r.push(n);
    return r;
  }
  function da(e) {
    return Zr(e) ? Nh(e, !0) : Th(e);
  }
  ...
  function Wh(e, t) {
    var r = this.__data__;
    return (this.size += this.has(e) ? 0 : 1), (r[e] = xt && t === void 0 ? Gh : t), this;
  }
  function De(e) {
    var t = -1,
      r = e == null ? 0 : e.length;
  ...
  (De.prototype.clear = Dh),
    (De.prototype.delete = kh),
    (De.prototype.get = Bh),
    (De.prototype.has = zh),
    (De.prototype.set = Wh);
  function Hh() {
  ...
  function Wt(e, t) {
    for (var r = e.length; r--; ) if (Gt(e[r][0], t)) return r;
    return -1;
  }
  var Yh = Array.prototype,
    Jh = Yh.splice;
  function qh(e) {
    var t = this.__data__,
      r = Wt(t, e);
  ...
  (ye.prototype.clear = Hh),
    (ye.prototype.delete = qh),
    (ye.prototype.get = Qh),
    (ye.prototype.has = Xh),
    (ye.prototype.set = Kh);
  var Zh = Xr(Qe, 'Map');
  ...
  (et.prototype.clear = ev),
    (et.prototype.delete = rv),
    (et.prototype.get = nv),
    (et.prototype.has = ov),
    (et.prototype.set = av);
  function ha(e) {
  ...
  function kv(e) {
    return ya(e) ? Dv(e) : Ev(e);
  }
  function Iv(e) {
    return function (t) {
      t = ha(t);
      var r = ya(t) ? kv(t) : void 0,
        n = r ? r[0] : t.charAt(0),
  ...
  function Hv(e, t) {
    ...
    if (r instanceof ye) {
      var n = r.__data__;
      if (!pa || n.length < Wv - 1) return n.push([e, t]), (this.size = ++r.size), this;
  ...
  (rt.prototype.clear = Uv),
    (rt.prototype.delete = Vv),
    (rt.prototype.get = zv),
    (rt.prototype.has = Gv),
    (rt.prototype.set = Hv);
  var Sa = typeof exports == 'object' && exports && !exports.nodeType && exports,
    Oa = Sa && typeof module == 'object' && module && !module.nodeType && module,
    Yv = Oa && Oa.exports === Sa,
    Ca = Yv ? Qe.Buffer : void 0,
    xa = Ca ? Ca.allocUnsafe : void 0;
  function Jv(e, t) {
    if (t) return e.slice();
    var r = e.length,
      n = xa ? xa(r) : new e.constructor(r);
    return e.copy(n), n;
  }
  ...
  function Ra(e, t, r, n, o) {
    e !== t &&
      tm(
        t,
        function (a, i) {
          if ((o || (o = new rt()), Pe(a))) om(e, t, i, r, Ra, n, o);
          else {
...
`)}
    ...
    cn = (e) => {
      ...
      return (
        Object.keys(e).forEach((r) => {
          ...
          let o = n.split('-');
          o.length >= 2 && (o = o.map((a, i) => (i !== 0 ? Bv(a) : a))), (t[o.join('')] = e[r]);
        }),
        t
      );
    },
    ...
    Da = (e) => {
      ...
      const r = new Set(),
        n = (i, s) => {
          ...
          if (!Object.is(u, t)) {
            const f = t;
            (t = s ?? typeof u != 'object' ? u : Object.assign({}, t, u)), r.forEach((l) => l(t, f));
          }
        },
        o = () => t,
        a = {
  ...
  class pm {
    constructor() {
      _(this, 'varSpace', new Map());
    }
    get(t) {
      return this.varSpace.get(t);
    }
    add(t, r) {
      this.varSpace.set(t, r);
    }
    remove(t) {
      this.varSpace.delete(t);
    }
    destroy() {
      this.varSpace.clear();
    }
  ...
  class ka {
    constructor() {
      _(this, 'renderMode', 'normal'),
        _(this, 'components', {}),
        _(this, 'storeManager', new dm()),
        _(this, 'variableManager', new pm()),
        _(this, 'runtimeComponentCache', new Map()),
        _(this, 'onGetRef'),
        _(this, 'onGetComponent'),
        _(this, 'onComponentMount'),
        _(this, 'onComponentDestroy'),
        _(this, 'processNodeConfigHook');
    }
    getComponent(t) {
      var r;
      ...
      return (
        $a(o) || ((o = Aa(o)), (this.components[n] = o)),
    ...
    pageRender(
      ...
      (this.renderMode = u),
        ...
        (this.processNodeConfigHook = f);
      const l = t.value.componentsTree,
        p = this.getComponent(l),
          ...
          if (Rd(i)) {
            ...
            const f = (l) => {
              ...
              const d = this.getComponent(l),
                v = this.convertModelToComponent(d, l),
                g = s.params || [];
              return {
                component: (...E) => {
                  const w = sn(E, g),
                    j = this.getContext({ params: w }, r);
            ...
            if (Array.isArray(u)) {
              ...
              return (...p) =>
                l.map((d) =>
                  Ma(d.component) ? x.createElement(d.component, { $$context: r, key: d.key }) : d.component(...p)
                );
            } else return f(u).component;
          } else {
            if (Ae(i)) return ke(i.value, r || {});
            if (xd(i)) return Ta(i.value, r, this.storeManager);
            if (tt(i)) {
              let s = i;
              Wr(i) && (s = i.value);
              const u = s,
    ...
    convertModelToComponent(t, r) {
      ...
      class o extends x.Component {
        constructor(i) {
          super(i),
            _(this, '_CONDITION', !0),
            _(this, '_DESIGN_BOX', !1),
            _(this, '_NODE_MODEL', r),
            _(this, '_NODE_ID', r.id),
            _(this, 'UNIQUE_ID', `${r.id}_${pe()}`),
            _(this, 'targetComponentRef'),
            _(this, 'listenerHandle', []),
            _(this, 'storeState'),
            _(this, 'storeListenDisposeList', []),
            _(this, 'domHeader'),
            _(this, 'mediaStyleDomMap', {}),
            _(this, 'variableSpace'),
            _(this, 'nodeName'),
            _(this, 'updateState', (l) => {
              this.storeState.setState(l), this.forceUpdate();
            }),
            _(this, 'getStyleDomById', (l) => {
              const p = this.mediaStyleDomMap;
              let d = p[l];
              return d || ((d = document.createElement('style')), (p[l] = d)), (d.id = l), d;
            }),
            _(this, 'addMediaCSS', () => {
              var l;
              let p = this.domHeader;
              if (
                (p || ((p = (l = document.getElementsByTagName('head')) == null ? void 0 : l[0]), (this.domHeader = p)),
                !this.domHeader)
              )
                return;
              ...
              d &&
                d.value.forEach((v) => {
                  ...
                  let w = `.${d.class}`;
                  if ((v.state !== 'normal' && (w = `${w}:${v.state}`), Object.keys(v.style).length !== 0)) {
                    const j = this.getStyleDomById(E);
                    (j.innerText = `${w} { ${un(v.style)} }`), p == null || p.appendChild(j);
                  }
                  (g = v.media) != null &&
                    g.length &&
                    v.media.forEach((j) => {
          ...
          f
            ? (this.variableSpace = f)
            : ((this.variableSpace = { staticVar: {}, methods: {} }), n.variableManager.add(s, this.variableSpace));
        }
        connectStore() {
          const i = n.collectSpecialProps(r.props, (p) => !!Ae(p)),
            s = n.collectSpecialProps({ css: r.value.css, class: r.value.classNames }, (p) => !!Ae(p));
          let u = [];
          [...i, ...s]
            .map((p) => {
              const d = p.val,
          ...
          f.length &&
            f.forEach((p) => {
              n.storeManager.getStore(p) ||
                (n.storeManager.addStore(p, () => ({})), console.warn(n.storeManager, p, 'not exits'));
        ...
        componentWillUnmount() {
          var i;
          this.storeListenDisposeList.forEach((s) => s()),
            this.removeMediaCSS(),
        ...
        render() {
          ...
          r.value.componentName === Je.ROOT_CONTAINER &&
            ((p.globalState = this.state), (p.updateGlobalState = this.updateState));
          ...
          (d.methods = v), (this.variableSpace.methods = Object.assign(this.variableSpace.methods, v));
            ...
            return (
              (E = L.map((...H) => {
                ...
                const Se = n.getContext({ [_e]: be }, d),
                  ...
                  Jt =
                    ((he = r.value.classNames) == null
                      ? void 0
                      : he.map((te) => {
                          var Oe;
                          const Nt = te.name;
                          return Ae(te.status) && ke(String(((Oe = te.status) == null ? void 0 : Oe.value) || ''), Se)
                            ? Nt
                            : '';
                        })) || [];
                let nt = `${ee.className ?? ''} ${Jt.join(' ')}`.trim();
                r.value.css && (nt = `${r.value.css.class} ${nt}`.trim()), (ee.className = nt);
                const qt = n.transformProps(r.value.style, { $$context: Se });
                r.value.style && (ee.style = cn(qt || {}));
                const { children: Fe } = ee;
                let ot = [];
                if (Fe !== void 0) delete ee.children, (ot = Array.isArray(Fe) ? Fe : [Fe]);
                else {
                  const te = [];
          ...
          const w = n.transformProps(l, { $$context: d }),
            { children: j } = w;
          let O = [];
          if (j !== void 0) delete w.children, (O = Array.isArray(j) ? j : [j]);
          else {
            const L = [];
          ...
          const U =
            ((i = r.value.classNames) == null
              ...
              : i.map((L) => {
                  var H;
                  const he = L.name;
                  return Ae(L.status) && ke(((H = L.status) == null ? void 0 : H.value) || '', d) ? he : '';
                })) || [];
          let I = `${w.className ?? ''} ${U.join(' ')}`.trim();
          r.value.css && (I = `${r.value.css.class} ${I}`.trim()), (w.className = I);
          ...
          return (
            (this._CONDITION = ce.condition), ce.condition ? A : Le('div', { style: { display: 'none' }, children: A })
          );
        }
      }
      return _(o, '__CP_TYPE__', Yt), (o.displayName = `${r.value.componentName}Dynamic`), o;
    }
    ...
    render(t, r = {}, ...n) {
      return typeof t == 'string' || typeof t == 'number'
        ? String(t)
        : (lm.forEach((o) => {
            o in r && t.__CP_TYPE__ !== Yt && delete r[o];
          }),
  ...
  const hm = En(new ka()),
    ...
    gm = ({ children: e, width: t, height: r, $$attributes: n = [], ...o }) => {
      let a = e;
    ...
    bm = ({ children: e, $$attributes: t = [], ...r }) => {
      let n = e;
      return Array.isArray(e) || (n = [e]), x.createElement('canvas', { ...r, ...ge(t) }, ...n);
    },
    _m = ({ children: e, $$attributes: t = [], ...r }) => {
      let n = e;
      return Array.isArray(e) || (n = [e]), x.createElement('img', { ...r, ...ge(t) }, ...n);
    },
    jm = ({ children: e, $$attributes: t = [], ...r }) => {
      let n = e;
      return Array.isArray(e) || (n = [e]), x.createElement('video', { ...r, ...ge(t) }, ...n);
    },
    Em = ({ children: e, $$attributes: t = [], ...r }) => {
      let n = e;
      return Array.isArray(e) || (n = [e]), x.createElement('audio', { ...r, ...ge(t) }, ...n);
    },
    wm = ({ $$attributes: e = [], content: t, ...r }) => Le('span', { ...r, ...ge(e), children: t }),
    Sm = ({ children: e, $$attributes: t = [], afterMount: r, beforeDestroy: n, ...o }) => {
      let a = e;
      return (
        Array.isArray(e) || (a = [e]),
        x.useEffect(
  ...
  class Ia extends x.Component {
      ...
      super(t),
        ...
        _(this, 'rerender', (r) => {
          if ((this.props.adapter.clear(), (r == null ? void 0 : r.nodeType) === 'PAGE' && r))
            ...
            const n = r;
            this.setState({
              pageModel: new Vt(n, { materials: this.state.pageModel.materialsModel.rawValue }),
            });
          }
        }),
    ...
    render() {
      ...
      const s = { ...Cm, ...t.components },
        u = this.props.$$context ?? {};
      return (
        (u.refs = this.refManager),
        r.pageRender(i, {
          libs: {},
          components: s,
  ...
  class Mm extends x.Component {
    constructor(t) {
      super(t),
        _(this, 'instanceManager', new Fa()),
        _(this, 'renderRef'),
        _(this, 'dropPlaceholder', La),
        _(this, 'onGetComponent', (r, n) => {
          const o = this;
          class a extends x.Component {
            constructor() {
              super(...arguments),
                _(this, '_DESIGN_BOX', !0),
                _(this, '_NODE_MODEL', n),
                _(this, '_NODE_ID', n.id),
                _(this, '_UNIQUE_ID', `${n.id}_${pe()}`),
                _(this, '_STATUS');
            }
            componentDidMount() {
            ...
            render() {
              const { children: s = [], onlyRenderChild: u, ...f } = this.props;
              let l = s;
              return (
                Ze(s) || (l = [s]),
                !l.filter(Boolean).length &&
                  (n.isContainer() || n.value.componentName === Je.ROOT_CONTAINER) &&
                  l.push(x.createElement(o.dropPlaceholder, { node: n })),
                u ? l : x.createElement(r, f, ...l)
              );
            }
          }
          return x.forwardRef(function (i, s) {
            return x.createElement(Rm, { node: n, targetComponent: a }, x.createElement(a, { ref: s, ...i }));
          });
        }),
  ...
  const Ba = (e) => {
    ...
    Ua = (e) => {
      var t;
      return e ? ((t = e == null ? void 0 : e.stateNode) != null && t._DESIGN_BOX ? e : Ua(e.return)) : null;
    },
    $m = () => {
      const e = x.useRef(null);
      return {
  ...
  (function (e, t) {
    (function (r, n) {
      ...
      function s(d, v) {
        if (d) {
          var g = a[d];
          if (((o[d] = v), !!g)) for (; g.length; ) g[0](d, v), g.splice(0, 1);
        }
      }
      function u(d, v) {
      ...
      function f(d, v, g, E) {
        var w = document,
          ...
          U = g.before || r,
          I = d.replace(/[\?|#].*$/, ''),
          Y = d.replace(/^(css|img|module|nomodule)!/, ''),
          q,
          ce,
          A;
        if (((E = E || 0), /(^css!|\.css$)/.test(I)))
          (A = w.createElement('link')),
            (A.rel = 'stylesheet'),
            (A.href = Y),
            (q = 'hideFocus' in A),
            q && A.relList && ((q = 0), (A.rel = 'preload'), (A.as = 'style'));
        else if (/(^img!|\.(png|gif|jpg|svg|webp)$)/.test(I)) (A = w.createElement('img')), (A.src = Y);
        else if (
          ((A = w.createElement('script')),
          (A.src = Y),
          (A.async = j === void 0 ? !0 : j),
          (ce = 'noModule' in A),
          /^module!/.test(I))
        ) {
          if (!ce) return v(d, 'l');
          A.type = 'module';
        } else if (/^nomodule!/.test(I) && ce) return v(d, 'l');
        (A.onload =
          A.onerror =
          A.onbeforeload =
            function (L) {
      ...
      function p(d, v, g) {
        ...
        function j(O, U) {
          l(
            d,
            function (I) {
              u(w, I), O && u({ success: O, error: U }, I), s(E, I);
            },
            w
          );
        }
        if (w.returnPromise) return new Promise(j);
        j();
      }
      return (
